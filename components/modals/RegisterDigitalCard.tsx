        ...
        <div className="d-flex flex-column flex-md-row p-2">
                ...
                <Button
                  ...
                  onClick={async () => {
                    try {
                      ...
                      Alerting.create('success', 'Cartão Digital criado com sucesso!');
                    } catch (error) {
                      console.error(error);
          ...
          <div className="col-12 col-md p-2">
            <ListItem className="d-flex flex-column p-2">
              ...
              <div className="d-none d-md-flex rounded shadow mx-auto position-fixed" style={{ bottom: 0, transform: 'scale(.95)' }}>
                <DigitalCardPage
                  version={version}
                  username={username}
                  photoProfile={
