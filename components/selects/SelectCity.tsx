 ...
 */
 ...
 export function SelectCity(props: Props) {
   const { data: city, create: CreateCity } = useCityService(props.id);
   const { data: cities, update: UpdateCities, delete: DeleteCities } = useCitiesService();

   const [value, setValue] = useState<FilmOptionType | null>(city || null);
         ...
         onChange={(event: any, newValue) => {
           if (typeof newValue === 'string') {
             ...
             if (!newValue.inputUpdate) {
               handleAppendCity({ value: city.value });
             } else {
