      ...
      return setTimeout(() => {
        if (loading) {
          ...
          if (
            ...
            if (params.fallback && params.fallback.notification && params.fallback.notification.enabled)
              notification.error({
            ...
            session_validate(user.get().id)
              .then(() => {
                if (params.success && params.success.notification && params.success.notification.enabled)
